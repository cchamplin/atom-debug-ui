...
export default class Watchpoint {
  ...
  static deserialize (serialized) {
    ...
    return new Watchpoint({id:data.id, expression: data.expression})
  }
  ...
  setValue (context,value) {
    ...
    this._emitter.emit('atom-debug-ui.watchpoint.watchpointChanged',{watchpoint:this,context:context})
  }
  ...
  // Events
  // Events
  onWatchpointChanged(callback) {
    return this._emitter.on('atom-debug-ui.watchpoint.watchpointChanged', callback)
  }
  onWatchpointDestroyed(callback) {
    return this._emitter.on('atom-debug-ui.watchpoint.watchpointDestroyed', callback)
  }
}
Watchpoint.version = '1a'
