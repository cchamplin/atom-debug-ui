  ...
  */
  ...
  deactivateConsole() {
    if (this._consoleView != undefined && this._consoleView != null && !this._consoleView.isDestroyed()) {
      ...
      this._emitter.emit('atom-debug-ui.debugcontextview.consoleDeactivated', {context:this.getOption("context")})
    }
  }
  ...
  deactivateDebugger() {
    if (this._unifiedView != undefined && this._unifiedView != null && !this._unifiedView.isDestroyed()) {
      ...
      this._emitter.emit('atom-debug-ui.debugcontextview.debuggerDeactivated', {context:this.getOption("context")})
    }
  }
  ...
  onConsoleDeactivated(callback) {
    return this._emitter.on('atom-debug-ui.debugcontextview.consoleDeativated',callback)
  }
