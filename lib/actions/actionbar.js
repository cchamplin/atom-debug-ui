  ...
  render() {
    ...
    return <div className={classes}>
      ...
      <div className='atom-debug-ui-action-buttons'>
        ...
        <button className={(!state.visibleButtons.stepin ? 'btn-hidden ' : '') +"btn btn-action octicon icon-arrow-up inline-block-tight"} disabled={!state.buttons.stepin} onclick={this.handleStepIn}>
          <span className="btn-text">Step In</span>
        </button>
        <button className={(!state.visibleButtons.stepout ? 'btn-hidden ' : '') +"btn btn-action octicon icon-arrow-down inline-block-tight"} disabled={!state.buttons.stepout} onClick={this.handleStepOut}>
